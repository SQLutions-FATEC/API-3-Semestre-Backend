...
-- 2) FUNCIONARIOS
INSERT INTO employee (name, birth_date, sex, blood_type, deleted)
VALUES
    ('Davi','1993-01-01','M','A\+', false),
    ('Augusto','1987-02-02','M','O\+', false),
    ('Nicole','1990-03-21','F','A\-', false),
    ('Cainã','1991-01-04','M','O\+', false),
    ('Nathalia','1994-01-05','F','O\+', false),
    ('Roberto','1999-01-06','M','O\+', false),
    ('Glória','1990-01-07','F','O\-', false),
    ('João','1990-12-08','M','O\+', false),
    ('Luana','1992-01-09','F','AB\+', false),
    ('Bryan','1999-10-10','M','O\+', false),
    ('Enzo','1994-01-28','M','O\-', false),
    ('Lucas','1990-01-12','M','O\+', false),
    ('Mineda','1990-08-13','M','O\-', false),
    ('Daniel','1982-01-14','M','B\+', false),
    ('Carlos','1997-01-15','M','O\+', false),
    ('Felipe','1990-01-16','M','O\-', false),
    ('Bruno','1996-04-17','M','O\+', false),
    ('Renata','1990-05-17','F','A\-', false),
    ('Matheus','1991-01-21','M','O\+', false),
    ('Mirian','1989-01-20','F','A\+', false);
