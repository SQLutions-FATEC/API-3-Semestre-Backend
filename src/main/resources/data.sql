...
VALUES
    ...
    ('Cainã Melo','1991-01-04','M','O\+'),
    ('Nathalia','1994-01-05','F','O\+'),
    ('Roberto','1999-01-06','M','O\+'),
    ('Gloria Brito','1990-01-07','F','O\-'),
    ('Joao Lucas','1990-12-08','M','O\+'),
    ('Luana','1992-01-09','F','AB\+'),
    ('Bryan','1999-10-10','M','O\+'),
    ('Enzo Matheus','1994-01-28','M','O\-'),
    ('Lucas Nadalete','1990-01-12','M','O\+'),
    ('Mineda','1990-08-13','M','O\-'),
    ('Daniel Floriano','1982-01-14','M','B\+'),
    ('Carlos','1997-01-15','M','O\+'),
    ('Felipe José','1990-01-16','M','O\-'),
    ('Bruno','1996-04-17','M','O\+'),
    ('Renata','1990-05-17','F','A\-'),
    ('Matheus Pereira','1991-01-21','M','O\+'),
