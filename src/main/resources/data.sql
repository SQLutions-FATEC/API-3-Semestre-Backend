...
VALUES
    ('Davi','11111111111','1993-01-01','M','A+'),
    ('Augusto','11111111112','1987-02-02','M','O+'),
    ('Nicole','11111111113','1990-03-21','F','A-'),
    ('Cainã','11111111114','1991-01-04','M','O+'),
    ('Nathalia','11111111115','1994-01-05','F','O+'),
    ('Roberto','11111111116','1999-01-06','M','O+'),
    ('Glória','11111111117','1990-01-07','F','O-'),
    ('João','11111111118','1990-12-08','M','O+'),
    ('Luana','11111111119','1992-01-09','F','AB+'),
    ('Bryan','11111111120','1999-10-10','M','O+'),
    ('Enzo','11111111121','1994-01-28','M','O-'),
    ('Lucas','11111111122','1990-01-12','M','O+'),
    ('Mineda','11111111123','1990-08-13','M','O-'),
    ('Daniel','11111111124','1982-01-14','M','B+'),
    ('Carlos','11111111125','1997-01-15','M','O+'),
    ('Felipe','11111111126','1990-01-16','M','O-'),
    ('Bruno','11111111127','1996-04-17','M','O+'),
    ('Renata','11111111128','1990-05-17','F','A-'),
    ('Matheus','11111111129','1991-01-21','M','O+'),
    ('Mirian','11111111130','1989-01-20','F','A+');
